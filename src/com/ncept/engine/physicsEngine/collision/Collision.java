...
public class Collision {
    ...
    public static boolean isOnSight(GameObject go1, GameObject go2, int wid, int hei) {
        Rectangle hitbox1 = go1.getHitbox();
        Rectangle hitbox2 = go2.getHitbox();
        ...
        Rectangle sight = new Rectangle((int) (real_hitbox2.getCenterX() - (wid / 2)), (int) (real_hitbox2.getCenterY() - (hei / 2)),
                wid, hei);

        return real_hitbox1.intersects(sight);
    }
